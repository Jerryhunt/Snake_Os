...
void draw_cycle(unsigned char *buf,int xsize,int ysize,int x0,int y0,int r,unsigned char c);

//void draw_botton(char* buf,int xsize,int x0,int y0,int hig,char* s);
...
void draw_arrow(struct SHEET *sht,int x0,int y0,int x1,int y1,int c,int b);
void draw_button(struct SHEET *sht,int x0,int y0,char*s,int c ,int b);
/* timer.c */
